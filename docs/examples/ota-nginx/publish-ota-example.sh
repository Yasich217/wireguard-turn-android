...
# Example usage:
#   ./publish-ota-example.sh release /path/to/ui-release.apk 529 2.2.4 /path/to/ota
#   ./publish-ota-example.sh debug   /path/to/ui-debug.apk   529 2.2.4-debug /path/to/ota
