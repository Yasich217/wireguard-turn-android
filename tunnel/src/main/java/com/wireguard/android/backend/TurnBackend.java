...
public final class TurnBackend {
            ...
            Throwable lastError = null;
	            for (final NetworkCandidate candidate : candidates) {
                    ...
                    conn.setRequestProperty("Sec-Fetch-Site", "none");
	                    ...
	                    final String finalUrl = conn.getURL() != null ? conn.getURL().toString() : rawUrl;
	                    Log.d(TAG, "fetchUrlOnCurrentNetwork final URL for " + rawUrl + ": " + finalUrl);
        ...
        try {
            ...
            for (final NetworkCandidate candidate : candidates) {
                ...
                try {
                    ...
                    final String body = readResponseBody(bodyStream, responseBodyLimit(rawUrl));
    ...
    private static Map<String, String> buildVkRequestHeaders(String userAgent) {
        ...
        final boolean androidMobile = userAgent != null &&
            userAgent.contains("Android") &&
            (userAgent.contains("Mobile") || userAgent.contains("wv"));
        ...
        headers.put("sec-ch-ua-platform", androidMobile ? "\"Android\"" : "\"Windows\"");
        headers.put("sec-ch-ua", "\"Chromium\";v=\"146\", \"Not-A.Brand\";v=\"24\", \"Google Chrome\";v=\"146\"");
        headers.put("sec-ch-ua-mobile", androidMobile ? "?1" : "?0");
    ...
    private static int responseBodyLimit(String rawUrl) {
        if (rawUrl != null && rawUrl.contains("captchaNotRobot.getContent")) {
            // Slider content includes a large base64 image payload.
            return 2 * 1024 * 1024;
        }
        return 32768;
    }
    ...
    public static native void wgSetKernelModeSocketRouting(boolean enabled);
    public static native int wgTurnProxyStart(
            ...
            int streamsPerCred,
            int watchdogTimeout,
            String vkCredentialsProfile,
            int streamStartDelayMs,
